...
export default {
    ...
    label: 'Hue Shift',
    pass: 'pre-crt',
    paramKeys: ['hueRotate', 'hueCenter', 'hueWidth', 'hueFeather', ...fade.paramKeys, ...blend.paramKeys],
    handleParams: [...fade.handleParams],
    uiGroups: [
        { keys: ['hueRotate', 'hueCenter', 'hueWidth', 'hueFeather'] },
        fade.uiGroup,
        blend.uiGroup,
    ],
    params: {
        hueShiftEnabled: { default: false, label: 'Enable' },
        hueRotate:       { default: 0,   min: -180, max: 180, label: 'Hue Rotate' },
        hueCenter:       { default: 0,   min: 0,    max: 360, label: 'Range Center' },
        hueWidth:        { default: 360, min: 1,    max: 90,  label: 'Range Width' },
        hueFeather:      { default: 20,  min: 0,    max: 100,  label: 'Range Feather' },
        ...fade.params,
        ...blend.params,
    },
