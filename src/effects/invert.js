...
export default {
    ...
    params: {
        ...
        invertColorA:    { default: 'all', label: 'Color A', options: [['all', 'All Colors'], ...COLOR_OPTIONS] },
        invertColorB:    { default: 'bk',  label: 'Color B', options: COLOR_OPTIONS },
        invertColorC:    { default: 'none', label: 'Color C', options: COLOR_OPTIONS },
        invertColorD:    { default: 'none', label: 'Color D', options: COLOR_OPTIONS },
        invertColorE:    { default: 'none', label: 'Color E', options: COLOR_OPTIONS },
